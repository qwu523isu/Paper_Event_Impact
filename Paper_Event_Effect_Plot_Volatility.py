# -*- coding: utf-8 -*-
"""
Created on Thu Jun 19 16:23:23 2025
...
BTC_Vol_Result_File_Name = "btc_volatility_analysis_20250619_162145.csv"
...
def simple_enhanced_volatility_plot(results_df):
    ...
    fig.suptitle('BTC Options Volatility Analysis Results', fontsize=16, fontweight='bold')
    ...
    # Save plot
    plot_file = f"btc_analysis_{timestamp}.png"
...
# Model comparison
bates_rmse = results_df[results_df['model_type'] == 'Bates']['rmse'].mean()
heston_rmse = results_df[results_df['model_type'] == 'Heston']['rmse'].mean()
print(f"Bates model avg RMSE: {bates_rmse:.4f}")
print(f"Heston model avg RMSE: {heston_rmse:.4f}")
print(f"Better model: {'Bates' if bates_rmse < heston_rmse else 'Heston'}")